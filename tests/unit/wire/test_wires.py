...
@pytest.mark.parametrize(
    ...
    [
        (0, "motor_ignition", 1, 0.4)(  # wrong wire type: number
            "ignition", None, 1, 0.4
        )(  # wrong ignition_wire_type: None
            "ignition", 0, 1, 0.4
        )(  # wrong ignition_wire_type: number
            "ignition", "motor", "1", 0.4
        )(  # wrong current: str
            "ignition", "motor", 1, "0.4"
...
def test_current_directon(calisto):
    ...
    calisto.add_wire(horizontal_wire_1, [[0.001, 0.001, 0], [0.001, -0.001, 0]])
    calisto.add_wire(horizontal_wire_2, [[0.001, -0.001, 0], [0.001, 0.001, 0]])

    horizontal_wire_1.measure_magnetic_field([0, 0, 0])
    horizontal_wire_2.measure_magnetic_field([0, 0, 0])

    # calisto has the same user defined coordinate  as the body axis coordinate system (center at cdm and orientation tail to nose)
...
def test_from_dict():
    wire_dict = {
        "current": 3,
        "wire_type": "igniton",
        "ignition_wire_type": "motor_ignition",
