...
class _WirePlots():
    ...
    def _draw_wires(self, 
        ...
        edge_b_y = self.wire._wire_edges_from_cso[1][1]
        edge_a_z = self.wire._wire_edges_from_cso[0][2]
        edge_b_z = self.wire._wire_edges_from_cso[1][2]
        ...
        if edges_names == True:
            ...
            ax.annotate("Edge A", (edge_a_z, r_a), textcoords="offset points", xytext=(5, 5), fontsize=9)
            ax.annotate("Edge B", (edge_b_z, r_b), textcoords="offset points", xytext=(5, 5), fontsize=9)
