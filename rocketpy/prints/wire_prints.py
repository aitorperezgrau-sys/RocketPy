class _WirePrints():
    ...
    def edges(self):
        print(f'Edge A is {self.wire._wire_edges_from_cso[0]}, Edge B is {self.wire._wire_edges_from_cso[1]}')
    ...
    def magnetic_field_vector(self):
        for key in self.wire.magnetic_field:
            print(f'Magnetic field vector at position: {key} due to the wire is {self.wire.magnetic_field[key]}')
