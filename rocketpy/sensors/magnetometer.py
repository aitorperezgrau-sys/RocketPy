...
class Magnetometer(InertialSensor):
    ...
    _soft_iron_distortion_matrix_matrix: Matrix
    ...
    def apply_magnetic_interference(self, B: Vector, rocket: Rocket, parachute_events, burn_start_time: float, initial_time: float, current_time: float):
        '''
    ...
    def apply_activation_signal_interference(self, B: Vector, rocket: Rocket, parachute_events, burn_start_time: float, initial_time: float, current_time: float):
        '''
        This function applies the interference caused due to the current
                ...
                for ignition_wire in rocket.ignition_wires:
                    if ignition_wire.ignition_wire_function == 'parachute_ignition':
                        for parachute_event in parachute_events:
                            ...
                            if parachute.name == ignition_wire.parachute_name and ejection_time != 0:
                    ...
                    elif ignition_wire.ignition_wire_function == 'solid_motor_ignition':
