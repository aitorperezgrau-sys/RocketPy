...
class Magnetometer(InertialSensor):
    ...
    interferences (communication & ignition), thermal drifts, noise, and 
    quantization.
    ...
    def __init__(
        ...
        soft_iron_distortion : Matrix, string
            ...
            If a Matrix, applies a direct 3x3 
    ...
    def measure(self, time: float, **kwargs):
        '''
        ...
        '''
        # initialization of Parameters parameters
        ...
        B_cso = self.apply_magnetic_interference(B_cso, rocket, current_time, parachute_events)  # T

        #Transform body frame to sensor frame
        rotation_cso_to_sensor = self._total_rotation_sensor_to_body.transpose # includes the cross-axis sensitivity adjustment
    ...
    def apply_magnetic_interference(self, B: Vector, rocket: Rocket, current_time: float | int, parachute_events: list | None = None) -> Vector:
        ...
        B = self.apply_power_interference(B, rocket, current_time, parachute_events)  # T
    ...
    def apply_power_interference(self, B: Vector, rocket: Rocket, current_time: float, parachute_events: list | None = None) -> Vector:
        ...
        if self.initial_power_interference == 'wires' or self.initial_power_interference == 'personalized':
            ...
            B = self.apply_activation_signal_interference(B, rocket, current_time, parachute_events)
                    ...
                    if ignition_wire.ignition_wire_function == 'parachute_ignition':
                        if not parachute_events == None:
                            for parachute_event in parachute_events:
                                ...
                                initial_time = ejection_time - ignition_wire.lead_ignition_time
                                final_time = ejection_time + ignition_wire.extra_ignition_time
                        ...
                        initial_time = rocket.motor.burn_start_time  - ignition_wire.lead_ignition_time
                        final_time = rocket.motor.burn_start_time +  ignition_wire.extra_ignition_time
